DROP TABLE IF EXISTS `onspotmy_node_new_db`.`node_batteries`;
CREATE TABLE `onspotmy_node_new_db`.`node_batteries` (
...
INSERT INTO `onspotmy_node_new_db`.`node_batteries` (`lc_id`, `node_id`, `battery`, `t_stamp`)
VALUES
