DROP TABLE IF EXISTS `onspotmy_node_new_db`.`node_floors`;
CREATE TABLE `onspotmy_node_new_db`.`node_floors` (
...
INSERT INTO `onspotmy_node_new_db`.`node_floors` (`fl_id`, `lc_id`, `fl_name`, `fl_spc`)
VALUES
  (1, 1, 'L1', 16),
  (2, 1, 'L2', 16);